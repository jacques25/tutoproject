...
class FileMoverSpec extends ObjectBehavior
{
    ...
    function it_can_move_a_file_from_temporary_to_controlled_storage()
    {
        ...
        $newLcation = '/some/fake/real/path';

        $this->move($currentLocation, $newLcation)->shouldReturn(true);

        $this->filesystem->rename($currentLocation, $newLcation)->shouldHaveBeenCalled();
    }
}
